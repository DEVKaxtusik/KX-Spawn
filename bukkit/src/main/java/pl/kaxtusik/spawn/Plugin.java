...
public final class Plugin extends JavaPlugin {
    ...
    @Getter
    private boolean isWorldGuardPresent = false;
    ...
    private void checkWorldGuard() {
        if (getServer().getPluginManager().getPlugin("WorldGuard") != null) {
            ...
            this.getLogger().info("WorldGuard detected. Region-based features are enabled.");
        } else {
            this.getLogger().warning("WorldGuard not detected. Region-based features will be disabled.");
        }
    }
