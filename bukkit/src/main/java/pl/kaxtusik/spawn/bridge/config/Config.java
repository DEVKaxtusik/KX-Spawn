...
public class Config extends OkaeriConfig {
    ...
    private Map<String, Command> createDefaultCommands() {
        ...
        subCommands.put("set", new SubCommand("set", true, List.of("setspawn"), List.of("kx.spawn.set")));
        subCommands.put("reload", new SubCommand("reload", true, List.of("rl"), List.of("kx.spawn.reload")));

        Command spawnCommand = new Command("spawn", List.of("lobby"), List.of("kx.spawn.use"), subCommands, true);
